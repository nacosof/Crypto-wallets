...
from config import SUPPORTED_TOKENS, MIN_BTC_FEE, TESTNET
...
class BitcoinWallet:
    ...
    def send_token(self, to_address, amount, token_name):
        ...
        if token_name == 'BTC':
            ...
            if balance < amount + MIN_BTC_FEE:
                return {"success": False, "error": f"Insufficient BTC. Balance: {balance}, required: {amount + MIN_BTC_FEE} (including fee)"}
